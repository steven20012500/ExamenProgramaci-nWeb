...
public class producto {
	...
	+ "<td> <a href= modificarP.jsp?cod=" + rs.getInt(1) + ">Modificar</a></td>"
	+ "<td> <a href= eliminarP.jsp?cod=" + rs.getInt(1) + ">Eliminar</a></td>"
	+ "</tr>";
	}
	...
	public Double consultarPrecio(int idProducto) {
	    double precio = 0;
	    String sql = "SELECT precio FROM tb_producto WHERE id_prod = ?";
	    conexion con = new conexion();
	    ResultSet rs = null;
	    rs = con.Consulta(sql);
	    try {
